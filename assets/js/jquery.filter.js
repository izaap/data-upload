...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            var serch = $("#date_range");
            serch.append('<span class="pull-left;">Dispatch</span>');
           
            //serch.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" class="pull-right date_range_filter" style="width:70px;padding:2px;margin:1px;" placeholder="To Date" id="' + sToId + '" rel="' + i + '"/>');
            serch.append(to);

             //serch.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" class="pull-right date_range_filter" style="width:70px;padding:2px;margin:1px;" placeholder="From Date" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            serch.append(from);

            //serch.append(_fnRangeLabelPart(2));
            serch.wrapInner('<span class="filterColumn filter_date_range" />');            
            to.datepicker();
            var index = i;
            aiCustomSearch_Indexes.push(i);
